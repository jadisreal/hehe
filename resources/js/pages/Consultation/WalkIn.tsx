...
const WalkIn: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Get the consultation type from localStorage or default to 'walk-in' since we're in the WalkIn component
        const type = localStorage.getItem('consultationType') || 'walk-in';
        ...
        // URL format: /consultation/(student|employee)/{id}/walk-in
        ...
        // Use the consultation service to submit data to the backend
        ...
        axios
            ...
            .then((consultationResponse) => {
                console.log('Consultation created successfully:', consultationResponse.data);
                console.log('Now submitting remark data:', remarkData);

                // Create the remark after consultation is created
                return axios.post('/api/remarks', remarkData);
            })
            .then((remarkResponse) => {
                console.log('Remark created successfully:', remarkResponse.data);
